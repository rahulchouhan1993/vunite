  ...
  return (
    ...
    <div className="relative bg-white relative py-20">
      <div className="container m-auto px-5 lg:px-0">
        <section className="realtive z-1 md:py-20 md:px-6 md:bg-white text-center rounded-[40px] md:shadow-[3px_3px_40px_rgba(0,0,0,0.1)] relative overflow-hidden">
          ...
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-start gap-8 relative">
            ...
            <div className="max-w-[100px] lg:max-w-[200px] pt-[30px] hidden md:block">
              <img src={arrow} />
            </div>
