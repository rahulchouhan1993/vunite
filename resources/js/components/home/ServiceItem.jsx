...
export default function FadingServiceItem({service, idx}) {
  return (
   <div key={idx} className=" bg-[#E4EEED] rounded-[20px]  hover:shadow-lg transition group">
      <div className='p-3'>
         <img src={service?.img} alt={service.title} className="fading w-full rounded-[15px] h-[150px] object-cover" />
      </div>
      <div className="px-6 py-[20px]">
         ...
         <a href="#" className="fading text-sm lg:text-[14px] font-semibold uppercase tracking-wider flex items-center gap-1 group-hover:gap-2 transition-all">
