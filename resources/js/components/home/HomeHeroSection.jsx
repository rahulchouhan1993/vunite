    ...
    <>
      ...
      <div className='container mx-auto px-5 lg:px-0 relative mt-[10px]'>
        ...
        <div className='relative'>
                ...
                <div className="px-6 py-10 sm:px-10 sm:py-12 lg:px-[60px] lg:py-[60px] max-w-full sm:max-w-[600px] lg:max-w-[800px] w-full relative text-white">
                  ...
                  <div className="space-y-3 mb-8">
                    {['Nurse-led care approach', 'NDIS Registered Provider', 'Qualified Support Workers', 'Person-Centred Care'].map((item, idx) => (
                      <div key={idx} className="fading text-sm md:text-normal lg:text-[16px] flex items-center gap-3">
          ...
          <div className=" flex justify-center p-3 overflow-hidden items-center absolute bg-[#6c2a75] rounded-full w-[80px] h-[80px] sm:w-[100px] sm:h-[100px] lg:w-[130px] lg:h-[130px] bottom-4 right-4  z-10">
              <img className="w-full" src={ndis} alt="NDIS" />
          </div>
        </div>
      </div>
    </>
