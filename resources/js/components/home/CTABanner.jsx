    ...
    <section className="container mx-auto px-6 mb-20">
      <div className="bg-[#E4EEED] rounded-3xl py-10 lg:py-12 px-6 lg:px-16 flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="w-full lg:max-w-[50%]">
          <h2 className="font-recoleta text-3xl md:max-w-[380px] leading-[50px] font-bold text-main mb-2">You're already funded, but are you receiving the care you deserve?</h2>
        </div>
