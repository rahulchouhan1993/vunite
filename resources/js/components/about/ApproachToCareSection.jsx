...
const ApproachToCareSection = () => {
  ...
  return (
    <section className="py-20 lg:py-24 bg-[#E4EEED] relative ">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className='flex justify-start items-center'>
          ...
          <div className="ps-[50px] w-full max-w-[65%]  mx-auto">
            <h2 className="fading font-recoleta text-3xl sm:text-4xl lg:text-5xl font-bold text-pink mb-4">
              Our Approach to Care
            </h2>
            <p className=' text-gray-500 mb-8 mt-3 fading'>We believe high-quality disability support is built on:</p>
            <div className=" grid grid-cols-1 md:grid-cols-1 gap-2">
              {bulletPoints.map((point, index) => (
                <div key={index} className="fading flex items-start gap-4">
