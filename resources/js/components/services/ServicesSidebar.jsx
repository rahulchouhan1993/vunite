      ...
      <nav className="flex lg:flex-col gap-3 lg:gap-0 overflow-x-auto lg:overflow-visible p-3 lg:p-0">
        {serviceCategories.map((category, index) => (
          <button
            ...
            className={`flex-shrink-0 lg:flex-shrink w-auto lg:w-full text-left px-4 md:px-4 py-3 rounded-lg transition-all duration-200 lg:border-b lg:border-gray-200 ${
